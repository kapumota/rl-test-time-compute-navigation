...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Genera capturas, CSV, GIF y figuras del dashboard.")
    parser.add_argument("--scenario", default="obstaculos_densos", help="Escenario de evaluación.")
    parser.add_argument("--method", default="RL-of-Thoughts Navigator", help="Método base del dashboard.")
    ...
    parser.add_argument("--output", type=Path, default=Path("results/paper_demo"), help="Directorio de salida.")
    parser.add_argument(
        "--methods",
        nargs="*",
...
def main() -> None:
    ...
    artifacts = controller.generate_paper_demo(output_dir=args.output, steps=args.steps, seed=args.seed, fps=args.fps)
